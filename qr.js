              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, ༒︎𝐋𝐎𝐑𝐃_𝐎𝐁𝐈𝐓𝐎-𝐌𝐃༒ User!* 👋🏻

Thanks for using *༒︎𝐋𝐎𝐑𝐃_𝐎𝐁𝐈𝐓𝐎-𝐌𝐃༒* — your session has been successfully created!
...
contextInfo: {
externalAdReply: {
title: "༒︎𝐋𝐎𝐑𝐃_𝐎𝐁𝐈𝐓𝐎-𝐌𝐃༒︎ 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃✅",
...
{quoted:code })
                            ...
                            let desc = `*Hey there, ༒︎𝐋𝐎𝐑𝐃_𝐎𝐁𝐈𝐓𝐎-𝐌𝐃༒︎ User!* 👋🏻

Thanks for using *༒︎𝐋𝐎𝐑𝐃_𝐎𝐁𝐈𝐓𝐎-𝐌𝐃༒︎* — your session has been successfully created!
...
{quoted:ddd })
    ...
    await LORD_OBITO_TECH_PAIR_CODE();
});
setInterval(() => {
